          ...
          return (
            ...
            >
              <div className="flex flex-1 flex-col gap-[4px]">
                <p className="text-[16px] text-[#1f2329] group-hover:text-[#0080FF] transition-colors">
                  {item.title}
                </p>
                <p className="text-[14px] font-light leading-normal text-[rgba(100,106,115,1)] group-hover:text-[#0080FF] transition-colors">
                  {item.subtitle}
                </p>
              </div>
